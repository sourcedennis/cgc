...
module _ {Γ} where
  ...
  α⟦ Skip ⟧ʷ♯ = ext[↗]⸢⊑⸣ $ λ {ρ♯} → let open ProofMode[⊑] in [proof-mode]
    𝑑𝑜 [[ α[ ⇄env⇄ ↗⸢⇄ᶜ⸣ (id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄) ] ⋅ ⟦ Skip ⟧ʷ ⋅ ρ♯ ]]
  ...
  α⟦ Assign x ae ⟧ʷ♯ = ext[↗]⸢⊑⸣ $ λ {ρ♯} → let open ProofMode[⊑] in [proof-mode]
    𝑑𝑜 [[ α[ ⇄env⇄ ↗⸢⇄ᶜ⸣ (id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄) ] ⋅ ⟦ Assign x ae ⟧ʷ ⋅ ρ♯ ]]
     ‣ [[ αᶜ[ id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄ ] *♮ ⋅ (⟦ Assign x ae ⟧ʷ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯)) ]]
     ‣ [focus-right [⋅] 𝑜𝑓 αᶜ[ id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄ ] *♮ ] begin
       𝑑𝑜 [[ ⟦ Assign x ae ⟧ʷ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯) ]]
        ‣ [focus-left [⋅] 𝑜𝑓 γᶜ[ ⇄env⇄ ] ⋅ ρ♯ ] begin
          𝑑𝑜 [[ ⟦ Assign x ae ⟧ʷ *♮ ]]
           ‣ [focus-in [*] ] begin
             𝑑𝑜 [[ ⟦ Assign x ae ⟧ʷ ]]
        ...
        ‣ [focus-right [⋅] 𝑜𝑓 (pure ⋅ ([,] ⋅ []ˢ♮)) *♮ ] begin
          𝑑𝑜 [[ (apply♮ ∘♮ apply⸢∧♮⸣ ⋅ ⟨ [*] ∘♮ pure ∘♮ extend♮[ x ] ,♮ ⟦ ae ⟧ᵃ♮ ⟩ ∘♮ split♮) *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯) ]]
           ...
           ‣ [focus-right [⋅] 𝑜𝑓 (uncurry♮ ⋅ (pure ∘♮ extend♮[ x ])) *♮ ] begin
             𝑑𝑜 [focus-right [⋅] 𝑜𝑓 γ⸢IA⸣ ] $ [focus-right [,] 𝑜𝑓 γᶜ[ ⇄env⇄ ] ⋅ ρ♯ ] begin
               𝑑𝑜 [[ ⟦ ae ⟧ᵃ♮ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯) ]]
                ‣ ⟅ π₁ γγᶜ[*][ ⇄env⇄ , ⇄ℤ⇄ ] (α[⟦⟧ᵃ] ae) ⟆
                ‣ [[ γᶜ[ ⇄ℤ⇄ ] *♮ ⋅ (pure ⋅ ⟦ ae ⟧ᵃ♯ ⋅ ρ♯) ]]
                ‣ ⟅ right-unit[*] ⟆⸢≈⸣
  ...
  α⟦ If be s₁ s₂ ⟧ʷ♯ = ext[↗]⸢⊑⸣ $ λ {ρ♯} → let open ProofMode[⊑] in [proof-mode]
    𝑑𝑜 [[ α[ ⇄env⇄ ↗⸢⇄ᶜ⸣ (id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄) ] ⋅ ⟦ If be s₁ s₂ ⟧ʷ ⋅ ρ♯ ]]
     ‣ [[ αᶜ[ id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄ ] *♮ ⋅ (⟦ If be s₁ s₂ ⟧ʷ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯)) ]]
     ‣ [focus-right [⋅] 𝑜𝑓 αᶜ[ id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄ ] *♮ ] begin
       𝑑𝑜 [[ ⟦ If be s₁ s₂ ⟧ʷ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯) ]]
        ‣ [focus-left [*] 𝑜𝑓 γᶜ[ ⇄env⇄ ] ⋅ ρ♯ ] begin
          𝑑𝑜 [[ ⟦ If be s₁ s₂ ⟧ʷ ]]
           ‣ ⟅ β[If] ⟆
        ...
        ‣ [focus-right [⋅] 𝑜𝑓 (uncurry♮ ⋅ (pure ∘♮ if∘♮ ⋅ ([,] ⋅ ♮⟨ s₁ ⟩) ⋅ ([,] ⋅ ♮⟨ s₂ ⟩))) *♮ ] begin
          𝑑𝑜 [[ γ⸢IA⸣ ⋅ ⟨ γᶜ[ ⇄env⇄ ] ⋅ ρ♯  ,♮ ⟦ be ⟧ᵇ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯) ⟩ ]]
  ...
  α⟦ While be s ⟧ʷ♯ = ext[↗]⸢⊑⸣ $ λ {ρ♯} → let open ProofMode[⊑] in [proof-mode]
    𝑑𝑜 [[ α[ ⇄env⇄ ↗⸢⇄ᶜ⸣ (id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄) ] ⋅ ⟦ While be s ⟧ʷ ⋅ ρ♯ ]]
     ‣ [[ αᶜ[ id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄ ] *♮ ⋅ (⟦ While be s ⟧ʷ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯)) ]]
     ‣ [focus-right [⋅] 𝑜𝑓 αᶜ[ id⸢⇄ᶜ⸣ ∧⸢⇄ᶜ⸣ ⇄env⇄ ] *♮ ] begin
       𝑑𝑜 [[ ⟦ While be s ⟧ʷ *♮ ⋅ (γᶜ[ ⇄env⇄ ] ⋅ ρ♯) ]]
        ‣ [focus-left [*] 𝑜𝑓 γᶜ[ ⇄env⇄ ] ⋅ ρ♯ ] begin
          𝑑𝑜 [[ ⟦ While be s ⟧ʷ ]]
           ‣ ⟅ β[While] ⟆
